...
//string default_config = "D:/Data/SFGD/FCT/config/config_FCT2_newGUI_V2.xml";
string file_name = "/DATA/neutrino/FCT/Troubleshooting/test_drive_STOPDAQBUG_resetPSC";
//string file_name = "D:/Data/SFGD/FCT/Data/test_drive_STOPDAQBUG_resetPSC";
...
void ScriptMain(){
	...
	{		
		...
		System.Console.WriteLine("Turning FEB off");
		TurnOffFEB();
		System.Console.WriteLine("FEB is off");
		
		System.Console.WriteLine("-----------------------------");		
		System.Console.WriteLine("LOOP : " + l_i.ToString());
		System.Console.WriteLine("-----------------------------");		
	}
	
	System.Console.WriteLine("-----------------------------");		
	System.Console.WriteLine("Number of LOOP : " + l_i.ToString());
	System.Console.WriteLine("-----------------------------");
}
...
{    
    int l_ret = 0;
	 ...
	 BoardLib.SetVariable("Board.UsbEthParam.FileLimit", 100000);
    ...
    for(int i=0;i<32;i++){        
	 ...
	 System.Console.WriteLine("XFER Bytes: " + BoardLib.XferKBytes);
	 System.Console.WriteLine("Avg. XFER rate: " + BoardLib.AvgXferRate);
    ...
    if(!BoardLib.IsTransferingData){
	 ...
	 System.Console.WriteLine("Stopping DAQ...");
	 BoardLib.SetBoardId(0); 
    ...
    System.Console.WriteLine("END OF ACQUISITION");
	 ...
	 System.Console.WriteLine("Stopping GTS and Gate...");
    BoardLib.SetBoardId(126); 
	 BoardLib.SetVariable("GPIO.GPIO-DIRECT-PARAMS.GTSEn",false);
    BoardLib.UpdateUserParameters("GPIO.GPIO-DIRECT-PARAMS"); 
