void ScriptMain(){
    ...
    string file_name = "FCT_os_LG"+LG.ToString()+"HG"+HG.ToString()+"amp"+((int)1000*amplitude).ToString()+"mV_";
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    System.IO.Ports.SerialPort l_serialPort = SetUpPulseGenerator(amplitude);
                                                                        System.Console.WriteLine("Pulse Gen is configured");
    

    BoardLib.SetBoardId(126); 
    BoardLib.SetVariable("GPIO.GPIO-DIRECT-PARAMS.GateGenEn",true);
    BoardLib.UpdateUserParameters("GPIO.GPIO-DIRECT-PARAMS");

    BoardLib.SetBoardId(0); 
    Sync.Sleep(500);                                                                    
    BoardLib.StartAcquisition(data_path + file_name+"crappy",true); 
...
System.IO.Ports.SerialPort SetUpPulseGenerator(double amplitude = 0.18){
    ...
    l_serialPort.WriteLine("PULSWID 1E-6");
            Sync.Sleep(500);        
    l_serialPort.WriteLine("PULSPER 900E-6");
            Sync.Sleep(500);
